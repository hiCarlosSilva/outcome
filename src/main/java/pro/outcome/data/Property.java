...
public class Property<T> {
	...
	// For Entity:
	Property(Entity<?> parent, Class<T> cl, String name, boolean indexed, ValueGenerator<T> def, Constraint ... constraints) {
		...
		// Note: presence of onDelete constraint is checked on Entity._addProperty
